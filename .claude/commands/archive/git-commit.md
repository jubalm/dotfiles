...
description: Intelligent git commits with optional file selection guidance [ARCHIVED]
---

# Git Commit Message Creation [ARCHIVED]

**Status:** Archived - Replaced by `/git-checkpoint`
