...
" Project: OneDark-Muted
" Derived from Nord Vim: https://github.com/arcticicestudio/nord-vim
" License: MIT
...
let s:nord1_gui = "#2D333F"
let s:nord2_gui = "#3A404C"
...
" Use the shared text color so the editor blends with the terminal surfaces.
